...
class PlaylistTracksTable(Base):
	__tablename__ = 'playlist_tracks_table'
	...
	def __init__(self, track: PlaylistTrackItem):
		self.added_at = utils.parse_time(track.added_at)
...
class PlaylistTable(Base):
	...
	tracks: list[PlaylistTracksTable] = relationship(
            'PlaylistTracksTable', back_populates='playlist')
...
class TrackTable(Base):
	...
	playlists: list[PlaylistTracksTable] = relationship(
            'PlaylistTracksTable', back_populates='track')
...
class LikedTable(Base):
	...
	def added_at(self, added_at: str):
		self._added_at = utils.parse_time(added_at)
